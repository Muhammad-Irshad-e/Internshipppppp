...
const Navbar = () => {
  ...
  useEffect(() => {
    if (isSignedIn) {
      if (user.primaryEmailAddress.emailAddress === 'irshad11@gmail.com') {
        navigate('/admindb');
      } else {
        navigate('/userdb');
      }
  ...
  return (
    <div className='m-0 p-0'>
       <nav className="bg-blue-600 text-white py-3 px-6 flex justify-between items-center" style={{backgroundColor:'#1976d2'}}>
        ...
        <Button variant="outlined" color="inherit" onClick={openSignIn}>
            Login
        </Button>
      ...
      <header className="relative h-96 bg-cover bg-center flex flex-col items-center justify-center text-white text-center p-8 bg-[url('job-a-darkened.jpeg')]  " >
        ...
        <a href="#feature">
        <button   className="mt-4 bg-blue-700 p-4 rounded-xl"  style={{backgroundColor:'#1976d2'}}>Discover More</button></a>
      </header>
      
      {/* About Section */}
      <section className="py-12 px-6" id="feature">
        <h2 className="text-2xl font-bold mb-6 text-center text-blue-700"  style={{color:'#1976d2'}}>About</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 justify-center">
          ...
          <Card className="bg-white shadow-lg rounded-none overflow-hidden border-2 border-gray-200 transition-transform transform hover:scale-105 hover:shadow-xl max-w-xs mx-auto">
            <CardContent className="p-6">
              <h3 className="text-xl font-semibold text-blue-700" style={{color:'#1976d2'}}>Advanced Job Search</h3>
          ...
          <Card className="bg-white shadow-lg rounded-none overflow-hidden border-2 border-gray-200 transition-transform transform hover:scale-105 hover:shadow-xl max-w-xs mx-auto">
            <CardContent className="p-6">
              <h3 className="text-xl font-semibold text-blue-700" style={{color:'#1976d2'}}>Instant Job Alerts</h3>
              <p className="text-gray-600 mt-4">
          ...
          <Card className="bg-white shadow-lg rounded-none overflow-hidden border-2 border-gray-200 transition-transform transform hover:scale-105 hover:shadow-xl max-w-xs mx-auto">
            <CardContent className="p-6">
              <h3 className="text-xl font-semibold text-blue-700" style={{color:'#1976d2'}}>Company Profiles</h3>
              <p className="text-gray-600 mt-4">
          ...
          <Card className="bg-white shadow-lg rounded-none overflow-hidden border-2 border-gray-200 transition-transform transform hover:scale-105 hover:shadow-xl max-w-xs mx-auto">
  <CardContent className="p-6">
    <h3 className="text-xl font-semibold text-blue-700" style={{color:'#1976d2'}}>Easy Application</h3>
    <p className="text-gray-600 mt-4">
      ...
      <footer className="bg-blue-700 text-white text-center py-6 mt-12"  style={{backgroundColor:'#1976d2'}}>
